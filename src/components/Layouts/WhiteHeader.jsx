...
export default function WhiteHeader({
  ...
  return (
    <>
      ...
      <header
        className={`header-section d-none d-lg-block ${(scrollClass && 'navbar-visible') || ''} ${
            ...
            <Navbar.Brand className="position-relative lpt-logo py-0 me-0">
              <Link href={'/'} title="WsCube Tech">
                <span className="d-block web-logo">
                  <Image
                    src={` ${(scrollClass && '/images/wscube-tech-logo-2.svg') || '/images/ws-cube-white-logo.svg'}`}
                    alt="header-logo"
                    width="149"
                    height="60"
                  />
                  ...
                  <div className="user-dropdown">
                    <div className="dropdown" ref={dropdownRef}>
                      <button
                        ...
                        className="white-fill-btn min-h-46 py-12 px-20 rounded-12 fs-16 fw-600 lh-24 d-flex align-items-center user-dropdown-btn dropdown-toggle cursor-pointer"
                      >
                  ...
                  <div className="user-dropdown skills-dropwdown">
                    <div className="dropdown" ref={dropdownRef2}>
                      <div
                        ...
                        className="white-fill-btn skills-toggle min-h-46 py-12 px-20 rounded-12 fs-16 fw-600 
                        lh-24 d-flex align-items-center user-dropdown-btn border-0 dropdown-toggle  cursor-pointer"
                      >
                  ...
                  <div className={`user-btn-wrapper d-flex align-items-center`}>
                    {(loading && <></>) ||
                      (!isLoggedIn && (
                        ...
                        <>
                          <UserDropdown dropdownClass="dropdown-white-header" initials={initials} />
                        </>
                      )}
                  </div>
                </div>
      ...
      {(showHeaderStriped && tobarBarData && !sideMenuActive && (
        <div className="d-lg-none d-flex fs-14 text-black bg-color-31 py-2 pe-3">
          <HeaderMarquee pauseOnHover={true} speed={40}>
            {parse(tobarBarData?.content)}
          </HeaderMarquee>
        ...
        ''} */}
      <header
        className={`d-lg-none  mobile-header position-absolute w-100
        ${(scrollClass && 'navbar-mobile-visible') || ''}
        ${scrollBanner ? 'nav-mobile-scrolled' : ''} 
        ${sideMenuActive ? 'position-sticky top-0' : ''}`}
      >
        <div
          className={`h-size-72 w-100 mobile-navbar transation-1 d-flex justify-content-between align-items-center px-16
        ${!scrollBanner ? 'bg-transparent' : ''}
        ${sideMenuActive ? 'add-new-bg' : ''}
        `}
        >
          <Link href={'/'} className="d-block">
            <Image src={`/images/ws-cube-white-logo.svg`} alt="logo" width={120} height={48} />
          </Link>
          <div className="d-flex align-items-center">
            {sideMenuActive && (
              <div className="header-dropdown mr-24">
                <div className="dropdown" ref={dropdownRef}>
                  <div
                    onClick={toggleDropdown}
                    className="white-fill-btn min-h-40 py-9 px-10 rounded-8 fs-14 fw-600 lh-21 d-flex align-items-center header-dropdown-btn cursor-pointer"
                  >
            ...
            {(sideMenuActive && (
              <button className="p-0 bg-transparent border-0 outline-none shadow-none">
                <Image
                  src={`${process.env.IMG_PATH}images/icons/menu-white-close-icon.svg`}
                  alt="menu"
                  width={24}
                  height={16}
              ...
              <button className="p-0 bg-transparent border-0 outline-none shadow-none">
                <Image
                  src={`${process.env.IMG_PATH}images/mobile-menu-icon.svg`}
                  alt="menu"
                  width={24}
                  height={16}
      ...
      <div
        className={`mobile-hamburgur w-100 p-16 d-lg-none d-block scrollbar-hidden ${
      ...
      >
        <div className="d-flex flex-column justify-content-between h-100">
          <div className="div">
            {(loading && <></>) ||
              (isLoggedIn && (
                <div className={`d-lg-none d-block user-details-responsive-white px-16 mb-0`}>
                  <ul
                    className="list-unstyled pb-20"
                    style={{
                      borderBottom: '1px solid #3C64FA',
                    }}
                  >
                    <li className="user-info py-12 d-flex mb-2 align-items-center">
                      ...
                      <div className="ml-12">
                        <h3 className="fs-14 lh-20 fw-500 mb-0 text-capitalize text-color-2">
                          {(user?.full_name?.length > 24 && `${user?.full_name?.substring(0, 18)}...`) ||
                            user?.full_name}
                        </h3>
                        <span className="fs-14 lh-20 fw-400 d-inline-block text-color-15 show-mobile-number">
                    ...
                    <li className="py-0 px-0">
                      <Link
                        ...
                        // onClick={resetFilter}
                        className="d-flex align-items-center mb-0 py-10 text-color-2"
                      >
                        <Image
                          src={`/images/icons/dashboard-home-white.svg`}
                    ...
                    <li className="py-0 px-0">
                      ...
                      >
                        <Image
                          src={`/images/icons/user-white-Icon.svg`}
                          className="fs-15 me-2"
                          width={16}
                          height={16}
                        />
            ...
            <ul className="list-unstyled mb-24 mobile-category-links">
              <li className="nav-items-list">
                <Link href={'/about'} className="" onClick={handleCloseMenu}>
                  <span className="d-inline-block py-12 px-16 fs-14 fw-600 lh-21 text-color-2">About Us</span>
                </Link>
              </li>
              <li className="nav-items-list">
                <div
                  className="d-flex justify-content-between py-12 px-16 fs-14 fw-600 lh-21 text-color-2 cursor-pointer"
                ...
                <div className={`pl-24 menu-list-show ${isSkillMenuMobile && 'menu-collapsed'}`}>
                  <div as="span" className="p-0 mb-8 dropdown-item">
                    <Link href={'/jaipur'} onClick={() => handleCloseMenu()}>
                      <div className="fs-16 fw-400 lh-24 text-color-2">
                        - <span className="label-gray fw-400 fs-14"> Jaipur</span>
                      </div>
                    </Link>
                  </div>
              ...
              <li className="nav-items-list">
                <Link href={'/'} className="" onClick={handleCloseMenu}>
                  <span className="d-inline-block py-12 px-16 fs-14 fw-600 lh-21 text-color-2">Apply as Mentor</span>
                </Link>
              </li>
              <li className="nav-items-list">
                <Link href={'/contact'} className="" onClick={handleCloseMenu}>
                  <span className="d-inline-block py-12 px-16 fs-14 fw-600 lh-21 text-color-2">Contact Us</span>
                </Link>
              </li>
            </ul>
          </div>
          <div>
            {(loading && <></>) ||
              (isLoggedIn && (
                <div className="responisve-auth-button mb-24">
                  <button
                    type="button"
                    className={`fs-14 fw-600 lh-24 rounded-12 bg-transparent header-btn-responsive max-w-300 ${'min-h-46 py-12 px-28 rounded-12 fs-14 fw-600 lh-24'}`}
                  ...
                  >
                    <Image
                      src={`/images/icons/logout-white-icon.svg`}
                ...
                <div className="d-grid grid-cols-2 grid-gap-32 w-100 responisve-auth-button">
                  <div>
                    <AuthButton
                      title="Login"
                      btnClass="header-btn-responsive bg-transparent min-h-46 w-100 text-color-2 d-block fs-12"
                      btnStyle={{
                        transition: '0.2s',
                        border: '2px solid rgba(255, 255, 255, 0.5)',
                        outline: 'none',
