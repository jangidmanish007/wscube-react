import { getCategoryDetails, getCategoryList, getCategoryMentorsList, getCategoryTargetsRoles, getCategoryTestmonials, getCategoryTopOpenings, getCategoryTopRecruiters } from '@/_services/categoryService';
...
export default async function DynamicPage() {
  ...
  return (
    <div>
      {pageType == 'category' && (
        <>
          <CourseCategory categoryDetailsData={categoryDetailsData} />
        </>
      )}
      {pageType == 'course' && (
        <>
          {courseDetails?.page_type == 2 &&
            <CourseDetailsDA details={courseDetails} params={params} /> || courseDetails?.page_type == 3 && <CourseDetailsEH details={courseDetails} params={params} />
            ||
            <CouresDetails details={courseDetails} params={params} />
          }
        </>
      )}
      {pageType == 'center' && (
