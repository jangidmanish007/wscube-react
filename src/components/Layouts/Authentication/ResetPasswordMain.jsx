...
export default function ResetPasswordMain({ emailToken }) {
              ...
              <div className="px-lg-32 px-16 pb-40 w-full max-w-520 mx-auto">
                {(resetSuccessfully && (
                  <div className="text-center">
                    ...
                    <div className="mb-lg-34 mb-20">
                      <h4 className="fs-25 fw-600 text-color-1 lh-38 mb-12">Password reset successfully!</h4>
                      <p className="fs-14 fw-400 lh-21 text-color-10">Please login to your account again.</p>
                    </div>
                    <AuthButton
                      title={'Login Now'}
                      btnClass={
                        'blue-fill-btn h-size-lg-56 h-size-46 px-36 fs-lg-18 fs-16 fw-lg-600 fw-500 w-100 rounded-12 orange-hover-shadow submit-book-class mx-lg-0 mx-auto mb-24'
                      }
                  ...
                  <>
                    <div className="mb-lg-24 mb-20">
                      <h4 className="fs-25 fw-600 text-color-1 lh-38 mb-12">Set your new Password</h4>
                  ...
                  border-w-2 border-color-1 input-focus-shadow bg-white"
                          ...
                          >
                            <Image
                              ...
                              alt="eye-toggle"
                              onClick={() =>
                                setShowPassword({ ...showPassword, confirmPass: !showPassword.confirmPass })
                              }
                            />
                          </span>
                        </div>
