            ...
            <div className="deatils-banner-left-side w-size-full max-w-xl-584 max-w-lg-480 mr-xl-110 mr-lg-40 mb-xl-0 mb-44">
             ...
             border-color-30-y py-lg-12 pr-lg-12 mb-xl-52 mb-lg-52 mb-44 course-info"
              >
                ...
                >
                  <div className="d-lg-flex justify-content-center mb-1 text-center">
                    <Image
                      src={`${process.env.IMG_PATH}images/icons/review-icon.svg`}
                      width={27}
                      height={27}
                    ...
                    <span className="ms-lg-1 fs-lg-22 fw-600 lh-lg-33 fs-18 lh-28 text-color-2 d-lg-flex d-block">
                      {details?.course_review}
                    </span>
                  </div>
                  <span className="fs-lg-16 lh-lg-24 fs-12 lh-16 fw-400 text-color-2">
                    {' '}
                    ({numberFormat(details?.course_review_count)} Reviews)
                  </span>
                </motion.li>
                <motion.li
                  initial={{ opacity: 0, x: -20 }}
                ...
                >
                  <div className="d-lg-flex justify-content-center mb-1 text-center">
                    <Image
                      src={`${process.env.IMG_PATH}images/icons/learner-icon.svg`}
                      width={27}
                      height={27}
                      className="img-fluid w-size-lg-27 w-size-21 mb-lg-0 mb-1"
                      alt="job-guarantee-icon"
                    />
                    <span className="ms-lg-1 fs-lg-22 fw-600 lh-lg-33 fs-18 lh-28 text-color-2 d-lg-flex d-block">
                      {numberFormat(details?.course_total_learners)}+
                    </span>
                  </div>
                  <span className="fs-lg-16 lh-lg-24 fs-12 lh-16 fw-400 text-color-2">Aspirants Mentored</span>
                </motion.li>
                <motion.li
                  initial={{ opacity: 0, x: -20 }}
                  whileInView={{ opacity: 1, x: 0 }}
              ...
              <div className="d-lg-none d-block">
                <BannerVideo details={details} courseSlug={courseSlug} />
              </div>
              {(!isHideCtaPage && (
                <div className="d-md-flex course-banner-btn">
                  {(courseSlug === 'digital-marketing-course' && (
                    <motion.button
                      initial={{ scale: 1 }}
                      whileTap={{ scale: 0.8 }}
                      ...
                      viewport={{ once: true }}
                      onClick={() => {
                        setLeadNote('Book Demo - Course Page - Banner');
                        setDownloadCrs(false);
                        setShowLeadModal(true);
                        setLeadHeading('Talk to Program Advisor');
                      }}
                      className="blue-fill-btn min-h-56 px-xl-36 px-lg-26 fs-18 fw-600 lh-27 rounded-12 orange-hover-shadow mr-xl-32 mr-20 mb-md-0 mb-24"
                    >
